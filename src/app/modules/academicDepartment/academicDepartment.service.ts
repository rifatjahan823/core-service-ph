...
// **************Create-Department************
const createAcademicDepartment=async (data:AcademicDepartment):Promise<AcademicDepartment> => {
    const result=await prisma.academicDepartment.create({data});
    return result
}

// ********************getAllDepartment*******************
const getAllDepartment=async (filters:IAcademicDepartmentFilterRequest,options:IPaginationOptions): Promise<IGenericResponse<AcademicDepartment[]>> => {

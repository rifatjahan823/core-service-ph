...
-- CreateIndex
CREATE UNIQUE INDEX "course_faculties_courseId_key" ON "course_faculties"("courseId");

-- CreateIndex
CREATE UNIQUE INDEX "course_faculties_facultyId_key" ON "course_faculties"("facultyId");
